"""Example of automatic vehicle control from client side with perception based cbf."""
...
from ctrl_perception_based_cbf import *
...
class CameraManager(object):
    ...
    def _parse_image(weak_self, image):
        ...
        if self.sensors[self.index][0].startswith('sensor.lidar'):
            ...
            front_camera_image = deepcopy(array[::5, ::5, :])
...
def game_loop(args):
    ...
    npzfile = np.load("map/map_shifted_waypoints.npz")
    x_map = npzfile['arr_0']
    y_map = npzfile['arr_1']
    ...
    # initialize the image to filter network
    img_to_cte = ImgToCTE()
    ...
    try:
        ...
        while True:
            ...
            list_cte_estimate.append(cte_es[0, 0])
        ...
        plt.plot(list_cte_estimate)
        plt.legend(("cte", "theta_e", "dot_phi_t", "steer", "h", "d_h_1/20",
                   "d_h_3/20", "status_is_feasible", "cte_estimate"))
        plt.show()
